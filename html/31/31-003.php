...
メールアドレス:<?php echo htmlspecialchars($mail, ENT_NOQUOTES, 'UTF-8');
?><br>
...
<input type="hidden" name="mail" value="<?php echo
htmlspecialchars($mail, ENT_COMPAT, 'UTF-8'); ?>">
<input type="hidden" name="gender" value="<?php echo
htmlspecialchars($gender, ENT_COMPAT, 'UTF-8'); ?>">
